...
public class Main : MonoBehaviour, SingularLinkHandler {
    ...
    public void SetCustomUserId_OnClick() {
        ...
        ShowToast("Custom User Id was set");
    }
    ...
    public void SendEventWithArgs_OnClick() {
        ...
        ShowToast("Event with args was sent");
    }
    ...
    public void SendRevenue_OnClick() {
        ...
        ShowToast("Revenue event was reported");
    }
    ...
    public void SendInAppPurchase_OnClick() {
        ...
        // Instead of sending an actuall product we create here a fake one to use for testing.
        // In production environment, the product object should be received from the Unity Purchasing API. 
        Product product = BuildProduct();
        SingularSDK.InAppPurchase("Test IAP", product, attributes);

        ShowToast("IAP was reported");
    }

    // Implementing this method will support Deferred Deep Links out of the box.
    ...
    private static Product BuildProduct() {
        // We can't simply create a product with a constructor. So we used reflection to do so.
